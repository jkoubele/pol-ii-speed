...
parser$add_argument("--sample_annotation",
                    ...
                    default = '/cellfile/datapublic/jkoubele/data_pol_ii/celegans_mutants/sample_annotation/sample_annotation.tsv')
parser$add_argument("--output_folder",
                    help = "",
                    default = '/cellfile/datapublic/jkoubele/data_pol_ii/celegans_mutants/sample_annotation')
