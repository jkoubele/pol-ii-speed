...
def load_dataset(results_folder: Path,
                 gene_file_name: str,
                 log_output_folder: Path) -> tuple[list[GeneData], DatasetMetadata]:
    """
    Load dataset from results folder generated by preprocessing pipeline.
    """
    ...
    gene_names_df = pd.read_csv(results_folder / 'gene_names' / gene_file_name)
    ...
    missing_exon_samples = set(dataset_metadata.sample_names) - set(exon_counts_df.columns)
    ...
    missing_intron_samples = set(dataset_metadata.sample_names) - set(intron_counts_df.columns)
